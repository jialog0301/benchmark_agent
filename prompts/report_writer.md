...
对排名前 3 的 Benchmark 进行详细分析，说明其优势和适用场景（需结合具体的 recommendation_reason 和评分维度）。
...
## 9. 参考资料
- Benchmark A: [论文链接/代码链接]
- Benchmark B: [论文链接/代码链接]
- ...
```

## Notes
- 报告必须与用户选择的 mode 对齐
- 表格中必须严格按照 Task-Fit Score 降序排名，并包含“排名”列
